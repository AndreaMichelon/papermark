        ...
        <Body className="bg-white font-sans">
          <Container className="mx-auto w-full max-w-[600px] p-0">
            ...
            <Section className="pb-6 text-center">
              ...
              <Link
                href="https://app.dataroom.europastudios.it/documents"
