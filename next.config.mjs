...
function prepareRemotePatterns() {
  let patterns = [
    ...
    { protocol: "https", hostname: "assets.dataroom.europastudios.it" },
    ...
    // papermark img
    { protocol: "https", hostname: "www.dataroom.europastudios.it" },
    { protocol: "https", hostname: "app.dataroom.europastudios.it" },
