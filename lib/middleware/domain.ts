...
export default async function DomainMiddleware(req: NextRequest) {
  ...
  // If it's the root path, redirect to dataroom.europastudios.it/home
  if (path === "/") {
    ...
    return NextResponse.redirect(
      new URL("https://www.dataroom.europastudios.it/home", req.url),
    );
  }
  ...
  return NextResponse.rewrite(url, {
    headers: {
      ...
      "X-Powered-By":
        "dataroom.europastudios.it - Document sharing infrastructure for the modern web",
    },
  });
}
